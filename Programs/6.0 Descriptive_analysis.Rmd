...
```
```{r}
a<-grid.arrange(plot6,plot15,plot1,plot2,plot5,plot4,plot3,plot7,plot8,plot9,plot10,plot11,plot12,plot13,plot14,ncol=3)
b<-grid.arrange(plot1,plot15,plot6,plot8,plot12,plot9,ncol=2)
c<-grid.arrange(plot1,plot15,plot6,plot8,ncol=2)
```
```{r}
ggsave("/Users/quangphucvu/Downloads/test.png", a, height = 10, width = 8, dpi = 1080)
ggsave("/Users/quangphucvu/Downloads/figure_1.png", b, height = 12, width = 8, dpi = 1080)
ggsave("/Users/quangphucvu/Downloads/figure_ppt.png", c, height = 12, width = 12, dpi = 1500)
```

```{r}
plot1+theme(text = element_text(size = 20),
        plot.title = element_text(size=16, face= "bold", colour= "black" ),
    axis.title.x = element_text(size=16, face="bold", colour = "black"),    
    axis.title.y = element_text(size=16, face="bold", colour = "black"))
```
```{r}
plot6+theme(text = element_text(size = 20),
        plot.title = element_text(size=16, face= "bold", colour= "black" ),
    axis.title.x = element_text(size=16, face="bold", colour = "black"),    
    axis.title.y = element_text(size=16, face="bold", colour = "black"))
```
```{r}
plot8+theme(text = element_text(size = 20),
        plot.title = element_text(size=16, face= "bold", colour= "black" ),
    axis.title.x = element_text(size=16, face="bold", colour = "black"),    
    axis.title.y = element_text(size=16, face="bold", colour = "black"))
```
...
```{r}
plot15+theme(text = element_text(size = 20),
        plot.title = element_text(size=16, face= "bold", colour= "black" ),
    axis.title.x = element_text(size=16, face="bold", colour = "black"),    
    axis.title.y = element_text(size=16, face="bold", colour = "black"))
```
