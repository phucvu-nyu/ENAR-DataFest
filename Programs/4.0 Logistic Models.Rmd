...
setwd("/Users/quangphucvu/Desktop/ENAR/Data")
...
```{r}
hist_data_2011<-data.frame(cycle=rep("2011-2012",length(hist_2011)),logit=hist_2011)
hist_data_2013<-data.frame(cycle=rep("2013-2014",length(hist_2013)),logit=hist_2013)
hist_data_2015<-data.frame(cycle=rep("2015-2016",length(hist_2015)),logit=hist_2015)
hist_data_2017<-data.frame(cycle=rep("2017-2020",length(hist_2017)),logit=hist_2017)
hist_data<-rbind(hist_data_2011,hist_data_2013,hist_data_2015,hist_data_2017)
a<-ggplot(hist_data, aes(x = logit.link, line = cycle,color=cycle)) + geom_density(alpha = 0.3)+xlim(c(-10,5))+xlab("Predicted logit")+ylab("Density")+
  theme(text = element_text(size = 20))
ggsave("/Users/quangphucvu/Downloads/test.png", a, height = 8, width = 10, dpi = 1080)
```
...
write.csv(Table_1,"/Users/quangphucvu/Desktop/ENAR/Tables and Figures/Coef_table.csv")
```
